    ...
    <div className="h-auto mt-3 flex items-center justify-center">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row gap-12 items-center">
          <div className="md:w-1/3 flex justify-center">
            <div className="relative w-60  h-60 rounded-full overflow-hidden border-6 border-primary/20">
              <img
                src="../assets/profile_cropped_circle.png"
                alt="Profile"
          ...
          <div className="md:w-2/3">
            <h2 className="text-3xl text-center md:text-start font-bold mb-5 underline">
              About Me
            </h2>

            <p className="mb-6 font-medium text-[18px] font-['sans-serif']">
            ...
            <p className="mb-8 font-medium text-[18px] font-['sans-serif']">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-16">
          <div>
            <div className="pt-6 shadow-md border-2 border-black rounded-md p-5 sm:p-6 md:p-7  hover:shadow-purple-600 h-auto transition-shadow duration-300 ">
              <h3 className="text-xl font-bold mb-2">Education</h3>
              <p className=" font-semibold text-[17px]  mb-4">
              ...
              <ul className="space-y-4">
                ...
                <li>
                  ...
                  <div className="text-sm text-gray-700 ">
                    Royal University Of Phnom Penh, 2023-now
                  </div>
                </li>
              </ul>
            </div>
          ...
          <div>
            <div className="pt-6 shadow-md border-2 border-black rounded-md p-5 sm:p-6 md:p-7  hover:shadow-purple-600 h-auto transition-shadow duration-300">
              ...
              <p className="text font-medium text-[17px] font-mono-muted-foreground mb-4">
